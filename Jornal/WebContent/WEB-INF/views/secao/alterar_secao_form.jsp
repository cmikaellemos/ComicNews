...
<div id="corpo">
 ...
 <section id="corpo">
	<form action="alterarSecao" method="post">
		...
		<p>Título:</p> 
		<input type="text" name="titulo" value="${secao.titulo}" size="40" required="required"/><br />
		<p>Descrição:</p> 
		<textarea rows="3" cols="33" name="descricao" required="required">${secao.descricao}</textarea><br /><br />
