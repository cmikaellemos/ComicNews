...
<div class="lista">	
	<table>
		...
		<tr>
			<td class="nomes">${a.titulo}</td>
			<td class="nomes">${a.descricao}</td>
			<td class="nomes"><a href="alterarSecaoForm?id=${a.id_secao}">Alterar</a></td>
			<td class="nomes"><a href="apagarSecao?id_secao=${a.id_secao}">Excluir</a></td>
		</tr>
		</c:forEach>
	</table>
</div>
