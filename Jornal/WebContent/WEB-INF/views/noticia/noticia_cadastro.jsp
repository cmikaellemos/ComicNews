...
<form action="cadastrarNoticia" method="post" enctype="multipart/form-data">
	...
	<p>Titulo: </p>
	<input type="text" size="70" maxlength="70" name="titulo" required="required" placeholder="Digite o título da noticia"/>
	<p>Subtitulo: </p>
	<input type="text" size="70" maxlength="70" name="subtitulo" required="required" placeholder="Digite o subtítulo da notícia"/>
	<p>Texto: </p>
	<textarea rows="10" cols="60" name="texto" required="required"></textarea>
	<p>Imagem: </p>
