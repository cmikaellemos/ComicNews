...
<form action="alterarNoticia" method="post">
	...
	<p>Título:</p> 
	<input type="text" name="titulo_n" size="70" required="required" value="${noticia_form.titulo}" /><br />
	<p>Subtitulo:</p> 
	<input type="text" name="subtitulo_n" size="70" required="required" value="${noticia_form.subtitulo}" /><br />
	<p>Texto:</p> 
	<textarea rows="10" cols="60" name="texto_n">${noticia_form.texto}</textarea><br/><br/>
