...
<form action="alterarClassificado" method="post">
	...
	<p>Titulo:</p>
	<input type="text" name="titulo_n" required="required" size="70" value="${classificado_alterar.titulo }"/>
	<p>Descrição:</p>
	<textarea rows="5" cols="60" required="required" name="texto_n">${classificado_alterar.texto }</textarea><br/>
	<p>Telefone:</p>
	<input type="tel" name="telefone_n" required="required" size="70" value="${classificado_alterar.telefone }"/>
	<p>Valor:</p>
	<input type="number" min="0" step="0.01" required="required" size="70" name="preco_n" value="${classificado_alterar.preco }"/><br/>
	<p>Imagem:</p>
