...
public class ClassificadoController {
	...
	@RequestMapping("/meusClassificados")
	public String meusClassificados(Long id, Model model){
		List<Classificado> ref = this.claDAO.recuperar_autor(id);
		model.addAttribute("classificados_listar", ref);
		return "classificado/listar_classificados";
	}
	
	@RequestMapping("/listarClassificados")
	public String listarClassificados(Model model, String tipo, String titulo_n, String ordem, Model modelN){
	...
	public String alterarClassificadoForm(Long id, Model model, Model modelN){
		List<Secao> secoes = sDAO.listar();
		modelN.addAttribute("secoes", secoes);
	...
	public String ofertar(Classificado classificado, Long id_cla, Long id_user, Double preco_n){
		...
		if(preco_n > ref.getMelhor_oferta() && preco_n >= ref.getPreco()){
	...
	public String listarClassificado(Long id_class, Model model, Model modelu, Model modelN){
		List<Secao> secoes = sDAO.listar();
		modelN.addAttribute("secoes", secoes);
